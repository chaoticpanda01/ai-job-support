...
export const translations = {
  ...
  onboarding: {
    ...
    s1Sub:       { en: "Japan Job Support uses AI to analyse your resume and generate career documents. Please read and accept the following before continuing.", id: "Japan Job Support menggunakan AI untuk menganalisis resume dan membuat dokumen karier. Baca dan setujui hal berikut sebelum melanjutkan.", ja: "Japan Job SupportはAIを使用して履歴書を分析し、キャリア書類を生成します。続行前に以下をご確認ください。" },
    s1Agree:     { en: "By continuing, you agree that Japan Job Support may:", id: "Dengan melanjutkan, kamu setuju bahwa Japan Job Support dapat:", ja: "続行することで、Japan Job Supportが以下を行うことに同意します：" },
    s1P1:        { en: "Process the content of your uploaded resume using the Gemini AI API to generate analysis, career documents, and job-match scores.", id: "Memproses konten resume yang diunggah menggunakan Gemini AI API untuk menghasilkan analisis, dokumen karier, dan skor kecocokan pekerjaan.", ja: "アップロードされた履歴書をGemini AI APIで処理し、分析・キャリア書類・マッチスコアを生成します。" },
    s1P2:        { en: "Store AI-generated results (scores, translations, documents) in our database to provide the service.", id: "Menyimpan hasil AI (skor, terjemahan, dokumen) di database kami untuk menyediakan layanan.", ja: "サービス提供のため、AI生成結果をデータベースに保存します。" },
    s1P3:        { en: "Send anonymised usage data as part of normal API operation. Your personal details are never used to train AI models.", id: "Mengirim data penggunaan anonim sebagai bagian dari operasi API normal. Data pribadimu tidak pernah digunakan untuk melatih model AI.", ja: "通常のAPI運用の一環として匿名データを送信します。個人情報はAIの学習に使用されません。" },
    s1Withdraw:  { en: "You can withdraw consent at any time by deleting your account from", id: "Kamu dapat mencabut persetujuan kapan saja dengan menghapus akun dari", ja: "アカウントを削除することで、いつでも同意を取り消せます（" },
    s1DangerZone:{ en: "Settings → Danger zone", id: "Pengaturan → Zona berbahaya", ja: "設定 → 危険ゾーン" },
    s1Checkbox:  { en: "I understand and consent to AI processing of my resume data as described above.", id: "Saya memahami dan menyetujui pemrosesan AI atas data resume saya seperti yang dijelaskan di atas.", ja: "上記の説明に従ったAIによる履歴書データの処理に同意します。" },
    s1Btn:       { en: "I agree — continue", id: "Saya setuju — lanjut", ja: "同意して続行" },
    // Step 2
    s2Title:     { en: "Welcome! Let's get started", id: "Selamat datang! Mari mulai", ja: "ようこそ！始めましょう" },
    s2Sub:       { en: "Tell us your name and preferred language.", id: "Beritahu kami nama dan bahasa yang kamu gunakan.", ja: "お名前と使用言語を教えてください。" },
    ...
    s3Sub:       { en: "Help us tailor your Japan job search.", id: "Bantu kami menyesuaikan pencarian kerja Jepang kamu.", ja: "日本での就職活動をカスタマイズします。" },
    s3Nation:    { en: "Nationality", id: "Kewarganegaraan", ja: "国籍" },
    s3CurrLoc:   { en: "Current location", id: "Lokasi saat ini", ja: "現在地" },
    s3TargLoc:   { en: "Target location in Japan", id: "Lokasi tujuan di Jepang", ja: "日本での希望勤務地" },
    s3ExpYears:  { en: "Years of work experience", id: "Tahun pengalaman kerja", ja: "職務経験年数" },
    // Step 4
    s4Title:     { en: "Japanese & preferences", id: "Bahasa Jepang & preferensi", ja: "日本語・希望条件" },
    s4Sub:       { en: "This helps us score your resume for the Japanese market.", id: "Ini membantu kami menilai resume kamu untuk pasar Jepang.", ja: "日本市場向けに履歴書のスコアを評価します。" },
    s4JpLevel:   { en: "Japanese level", id: "Tingkat bahasa Jepang", ja: "日本語レベル" },
    s4Visa:      { en: "Visa status", id: "Status visa", ja: "ビザ状況" },
    s4Industries:{ en: "Target industries (comma-separated)", id: "Industri target (pisahkan koma)", ja: "希望業界（カンマ区切り）" },
    s4Roles:     { en: "Target roles (comma-separated)", id: "Posisi target (pisahkan koma)", ja: "希望職種（カンマ区切り）" },
  ...
  resumes: {
    ...
    sub:            { en: "Upload your resume to get started. We'll analyse it for the Japanese job market.", id: "Unggah resumemu untuk memulai. Kami akan menganalisisnya untuk pasar kerja Jepang.", ja: "履歴書をアップロードして始めましょう。日本の就職市場向けに分析します。" },
    yourResumes:    { en: "Your resumes",      id: "Resume kamu",     ja: "あなたの履歴書" },
    noResumes:      { en: "No resumes yet. Upload one above.", id: "Belum ada resume. Unggah di atas.", ja: "まだ履歴書がありません。上でアップロードしてください。" },
    ...
    analysing:      { en: "Analysing your resume… this may take up to 30 seconds.", id: "Menganalisis resume kamu… ini mungkin membutuhkan waktu hingga 30 detik.", ja: "履歴書を分析中…最大30秒かかる場合があります。" },
    queued:         { en: "Analysis queued — results will appear here shortly.", id: "Analisis sudah diantri — hasil akan muncul sebentar lagi.", ja: "分析がキューに入りました — まもなく結果が表示されます。" },
    ...
    jpRequired:     { en: "Estimated Japanese required:", id: "Perkiraan bahasa Jepang yang dibutuhkan:", ja: "必要な日本語レベル（推定）：" },
  ...
  jobs: {
    ...
    sub:              { en: "Translate Japanese job postings and score them against your resume.", id: "Terjemahkan lowongan kerja Jepang dan cocokkan dengan resume kamu.", ja: "日本語の求人を翻訳し、履歴書とマッチングします。" },
    tracker:          { en: "Tracker",            id: "Pelacak",              ja: "管理" },
    translateBtn:     { en: "+ Translate posting", id: "+ Terjemahkan lowongan", ja: "+ 求人を翻訳" },
    searchPlaceholder:{ en: "Search job titles or summaries…", id: "Cari judul atau ringkasan lowongan…", ja: "求人タイトルや概要を検索…" },
    allScores:        { en: "All scores",         id: "Semua skor",           ja: "すべてのスコア" },
    noPostings:       { en: "No job postings found.", id: "Tidak ada lowongan kerja.", ja: "求人が見つかりません。" },
    ...
    loadError:        { en: "Failed to load job postings. Please refresh.", id: "Gagal memuat lowongan kerja. Coba muat ulang.", ja: "求人の読み込みに失敗しました。更新してください。" },
    ...
    confirmDelete:    { en: "Delete this job posting?", id: "Hapus lowongan ini?", ja: "この求人を削除しますか？" },
    // Translate page
    translateTitle:   { en: "Translate a Job Posting", id: "Terjemahkan Lowongan Kerja", ja: "求人を翻訳" },
    translateSub:     { en: "Paste the full text of a Japanese job posting and we'll translate it into Indonesian, extract key details, and score how foreigner-friendly it is.", id: "Tempel teks lengkap lowongan kerja Jepang dan kami akan menerjemahkannya ke Bahasa Indonesia, mengekstrak detail penting, dan menilai seberapa ramah untuk orang asing.", ja: "日本語求人の全文を貼り付けると、インドネシア語に翻訳し、詳細を抽出して外国人フレンドリー度を評価します。" },
    sourceUrl:        { en: "Source URL",         id: "URL Sumber",           ja: "ソースURL" },
    sourceUrlHint:    { en: "Used to detect duplicate translations. We do not fetch the URL.", id: "Digunakan untuk mendeteksi terjemahan duplikat. Kami tidak mengambil konten URL.", ja: "重複翻訳の検出に使用します。URLのコンテンツは取得しません。" },
    jobText:          { en: "Job posting text",   id: "Teks lowongan kerja",  ja: "求人テキスト" },
    jobTextPlaceholder:{ en: "Paste the full Japanese job posting text here…", id: "Tempel teks lengkap lowongan kerja Jepang di sini…", ja: "日本語求人の全文をここに貼り付けてください…" },
    minChars:         { en: "Minimum 50 characters required.", id: "Minimal 50 karakter diperlukan.", ja: "最低50文字必要です。" },
    ...
    jobNotFound:      { en: "Job posting not found.", id: "Lowongan tidak ditemukan.", ja: "求人が見つかりません。" },
    // Detail page info
    ...
    japaneseRequired: { en: "Japanese required",  id: "Bahasa Jepang dibutuhkan", ja: "必要な日本語" },
    ...
    translatedDesc:   { en: "Translated Description", id: "Deskripsi Terjemahan", ja: "翻訳された説明" },
    ...
    foreignerFriendly:{ en: "Foreigner Friendliness", id: "Keramahan terhadap Asing", ja: "外国人フレンドリー度" },
    ...
    toScoreJob:       { en: "to score this job.", id: "untuk menilai pekerjaan ini.", ja: "してこの求人をスコアリングしましょう。" },
    ...
    appSub:           { en: "Track your job applications through the hiring pipeline.", id: "Pantau lamaran kerja kamu melalui jalur rekrutmen.", ja: "採用プロセスを通じて応募状況を管理します。" },
    appLoadError:     { en: "Failed to load applications. Please refresh.", id: "Gagal memuat lamaran. Coba muat ulang.", ja: "応募の読み込みに失敗しました。更新してください。" },
    ...
    confirmRemove:    { en: "Remove this application from the tracker?", id: "Hapus lamaran ini dari pelacak?", ja: "この応募をトラッカーから削除しますか？" },
    source:           { en: "Source:",            id: "Sumber:",              ja: "ソース：" },
  },
  ...
  interview: {
    ...
    sub:             { en: "Practise with an AI interviewer and get real-time per-answer feedback.", id: "Berlatih dengan pewawancara AI dan dapatkan umpan balik real-time untuk setiap jawaban.", ja: "AIによる面接練習で、回答ごとのリアルタイムフィードバックを取得します。" },
    newSession:      { en: "+ New session",        id: "+ Sesi baru",           ja: "+ 新しいセッション" },
    noSessions:      { en: "No completed sessions yet.", id: "Belum ada sesi yang selesai.", ja: "完了したセッションはまだありません。" },
    startFirst:      { en: "Start your first practice interview.", id: "Mulai latihan wawancara pertama kamu.", ja: "最初の練習面接を始めましょう。" },
    loadError:       { en: "Failed to load sessions. Please refresh.", id: "Gagal memuat sesi. Coba muat ulang.", ja: "セッションの読み込みに失敗しました。更新してください。" },
    ...
    // New session
    newTitle:        { en: "Start a Mock Interview", id: "Mulai Wawancara Simulasi", ja: "模擬面接を始める" },
    newSub:          { en: "Practice with an AI interviewer and get real-time feedback on each answer.", id: "Berlatih dengan pewawancara AI dan dapatkan umpan balik real-time untuk setiap jawaban.", ja: "AIによる面接練習で各回答のフィードバックを受け取ります。" },
    interviewType:   { en: "Interview type",       id: "Jenis wawancara",       ja: "面接タイプ" },
    typeGeneral:     { en: "General",              id: "Umum",                  ja: "総合" },
    typeGeneralDesc: { en: "Self-introduction, motivation, and career goals — ideal for first practice.", id: "Perkenalan diri, motivasi, dan tujuan karier — ideal untuk latihan pertama.", ja: "自己紹介・動機・キャリア目標 — 初回練習に最適。" },
    typeBehavioral:  { en: "Behavioural",          id: "Perilaku",              ja: "行動" },
    typeBehavioralDesc:{ en: "STAR-method questions about past experience and how you handled situations.", id: "Pertanyaan metode STAR tentang pengalaman masa lalu.", ja: "過去の経験と対処法に関するSTAR方式の質問。" },
    typeTechnical:   { en: "Technical",            id: "Teknis",                ja: "技術" },
    typeTechnicalDesc:{ en: "Role-specific technical questions tailored to your target field.", id: "Pertanyaan teknis spesifik peran yang disesuaikan dengan bidang target kamu.", ja: "目標職種に合わせた技術的な専門質問。" },
    typeCulture:     { en: "Culture Fit",          id: "Kesesuaian Budaya",     ja: "文化適合" },
    typeCultureDesc: { en: "Japanese workplace culture: teamwork, 報連相, adaptability, and values.", id: "Budaya tempat kerja Jepang: kerja tim, 報連相, kemampuan adaptasi, dan nilai-nilai.", ja: "日本の職場文化：チームワーク、報連相、適応力、価値観。" },
    interviewLang:   { en: "Interview language",   id: "Bahasa wawancara",      ja: "面接言語" },
    context:         { en: "Context",              id: "Konteks",               ja: "コンテキスト" },
    contextHint:     { en: "optional — improves question quality", id: "opsional — meningkatkan kualitas pertanyaan", ja: "任意 — 質問の質が向上します" },
    rolePlaceholder: { en: "Target role (e.g. Software Engineer)", id: "Peran target (cth. Software Engineer)", ja: "希望職種（例：ソフトウェアエンジニア）" },
    companyPlaceholder:{ en: "Target company (e.g. Toyota)", id: "Perusahaan target (cth. Toyota)", ja: "希望企業（例：トヨタ）" },
    ...
    endConfirm:      { en: "End this interview session and get your overall feedback?", id: "Akhiri sesi wawancara ini dan dapatkan umpan balik keseluruhan?", ja: "このセッションを終了して全体フィードバックを取得しますか？" },
    stop:            { en: "Stop",                 id: "Berhenti",              ja: "停止" },
    send:            { en: "Send",                 id: "Kirim",                 ja: "送信" },
    inputPlaceholder:{ en: "Type your answer… (Enter to send, Shift+Enter for new line)", id: "Ketik jawabanmu… (Enter untuk kirim, Shift+Enter untuk baris baru)", ja: "回答を入力…（Enterで送信、Shift+Enterで改行）" },
    enterHint:       { en: "Enter to send · Shift+Enter for new line", id: "Enter untuk kirim · Shift+Enter untuk baris baru", ja: "Enterで送信 · Shift+Enterで改行" },
    ...
    readiness0:      { en: "More preparation needed", id: "Perlu lebih banyak persiapan", ja: "もっと準備が必要" },
  ...
  visa: {
    ...
    sub:             { en: "Personalised Japanese work visa roadmap based on your profile.", id: "Peta jalan visa kerja Jepang yang dipersonalisasi berdasarkan profilmu.", ja: "プロフィールに基づいた個別の日本就労ビザロードマップ。" },
    generateBtn:     { en: "Generate new roadmap", id: "Buat peta jalan baru",  ja: "新しいロードマップを生成" },
    generating:      { en: "Generating…",          id: "Membuat…",              ja: "生成中…" },
    noRoadmap:       { en: "No visa roadmap yet.", id: "Belum ada peta jalan visa.", ja: "ビザロードマップはまだありません。" },
    noRoadmapSub:    { en: "Click Generate new roadmap to get personalised guidance.", id: "Klik Buat peta jalan baru untuk mendapatkan panduan personal.", ja: "「新しいロードマップを生成」をクリックして個別ガイダンスを取得してください。" },
    generateFail:    { en: "Failed to generate roadmap. Please try again.", id: "Gagal membuat peta jalan. Coba lagi.", ja: "ロードマップの生成に失敗しました。再試行してください。" },
    recommendedVisa: { en: "Recommended visa category", id: "Kategori visa yang direkomendasikan", ja: "推奨ビザカテゴリ" },
    ...
    previousRoadmaps:{ en: "Previous roadmaps",    id: "Peta jalan sebelumnya", ja: "過去のロードマップ" },
    ...
    backToVisa:      { en: "← Back to Visa Guidance", id: "← Kembali ke Panduan Visa", ja: "← ビザガイダンスへ" },
    consultNotFound: { en: "Consultation not found.", id: "Konsultasi tidak ditemukan.", ja: "コンサルテーションが見つかりません。" },
  },
  ...
  documents: {
    ...
    sub:          { en: "Generate Japanese-format career documents from your resume.", id: "Buat dokumen karier format Jepang dari resume kamu.", ja: "履歴書から日本フォーマットのキャリア書類を生成します。" },
    all:          { en: "All",              id: "Semua",            ja: "すべて" },
    noDocuments:  { en: "No documents yet.", id: "Belum ada dokumen.", ja: "書類がまだありません。" },
    generateA:    { en: "Generate a",       id: "Buat",             ja: "生成する" },
    orLabel:      { en: "or",               id: "atau",             ja: "または" },
    toGetStarted: { en: "to get started.",  id: "untuk memulai.",   ja: "して始めましょう。" },
    loadError:    { en: "Failed to load documents. Please refresh.", id: "Gagal memuat dokumen. Coba muat ulang.", ja: "書類の読み込みに失敗しました。更新してください。" },
  ...
  settings: {
    ...
    sub:                { en: "Update your profile and manage your account.", id: "Perbarui profil dan kelola akunmu.", ja: "プロフィールの更新とアカウントの管理。" },
    profile:            { en: "Profile",           id: "Profil",               ja: "プロフィール" },
    nationality:        { en: "Nationality",       id: "Kewarganegaraan",      ja: "国籍" },
    jpLevel:            { en: "Japanese level (JLPT)", id: "Tingkat bahasa Jepang (JLPT)", ja: "日本語レベル（JLPT）" },
    jpNotTested:        { en: "Not tested / below N5", id: "Belum diuji / di bawah N5", ja: "未受験 / N5以下" },
    visaStatus:         { en: "Current visa status", id: "Status visa saat ini", ja: "現在のビザ状況" },
    visaNone:           { en: "No visa / not yet applied", id: "Belum ada visa / belum melamar", ja: "ビザなし / 未申請" },
    ...
    targetRolesHint:    { en: "Comma-separated list of job titles you're targeting", id: "Daftar jabatan target yang dipisahkan koma", ja: "希望する職種名のカンマ区切りリスト" },
    targetIndustries:   { en: "Target industries", id: "Industri target",      ja: "希望業界" },
    targetIndustriesHint:{ en: "Comma-separated list of industries you're interested in", id: "Daftar industri yang diminati, dipisahkan koma", ja: "興味のある業界のカンマ区切りリスト" },
    preferredLang:      { en: "Preferred language", id: "Bahasa yang digunakan", ja: "使用言語" },
    saveFail:           { en: "Failed to save. Please try again.", id: "Gagal menyimpan. Coba lagi.", ja: "保存に失敗しました。再試行してください。" },
    dangerZone:         { en: "Danger zone",       id: "Zona berbahaya",       ja: "危険ゾーン" },
    deleteAccount:      { en: "Delete account",    id: "Hapus akun",           ja: "アカウント削除" },
    deleteDesc:         { en: "Permanently delete your account and all associated data — resumes, documents, job postings, interview sessions, and visa consultations. This action cannot be undone.", id: "Hapus permanen akun dan semua data terkait — resume, dokumen, lowongan kerja, sesi wawancara, dan konsultasi visa. Tindakan ini tidak dapat dibatalkan.", ja: "アカウントと関連するすべてのデータ（履歴書・書類・求人・面接・ビザ相談）を完全に削除します。この操作は取り消せません。" },
    ...
    deleteFail:         { en: "Failed to delete account. Please try again.", id: "Gagal menghapus akun. Coba lagi.", ja: "アカウントの削除に失敗しました。再試行してください。" },
  },
