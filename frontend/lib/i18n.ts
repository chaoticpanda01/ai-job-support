...
export const translations = {
  ...
  documents: {
    ...
    notFound:        { en: "Document not found.", id: "Dokumen tidak ditemukan.", ja: "書類が見つかりません。" },
    ...
    generating:      { en: "Generating your document…", id: "Membuat dokumen kamu…", ja: "書類を生成中…" },
    genWait:         { en: "This usually takes 20–60 seconds. The page updates automatically.", id: "Biasanya membutuhkan 20–60 detik. Halaman diperbarui otomatis.", ja: "通常20〜60秒かかります。ページは自動で更新されます。" },
    genFailed:       { en: "Generation failed",   id: "Pembuatan gagal",         ja: "生成失敗" },
    genFailHint:     { en: "You can try again by creating a new document.", id: "Coba lagi dengan membuat dokumen baru.", ja: "新しい書類を作成して再試行できます。" },
    genSuccess:      { en: "Document generated successfully", id: "Dokumen berhasil dibuat", ja: "書類が正常に生成されました" },
    on:              { en: "on",               id: "pada",           ja: "：" },
    downloadPdf:     { en: "Download PDF",     id: "Unduh PDF",      ja: "PDFをダウンロード" },
    preparingLink:   { en: "Preparing download link…", id: "Mempersiapkan tautan unduhan…", ja: "ダウンロードリンクを準備中…" },
    linkExpiry:      { en: "Download links expire after 15 minutes. Refresh this page to get a new link.", id: "Tautan unduhan kedaluwarsa setelah 15 menit. Muat ulang halaman untuk mendapatkan tautan baru.", ja: "ダウンロードリンクは15分で失効します。新しいリンクを取得するにはページを更新してください。" },
    // Wizard — new rirekisho / shokumu pages
    generateRirekisho: { en: "Generate 履歴書",      id: "Buat 履歴書",      ja: "履歴書を生成" },
    rirekishoSub:    { en: "We'll convert your resume into a Japanese-format 履歴書 (rirekisho) PDF.", id: "Kami akan mengubah resume kamu menjadi PDF 履歴書 (rirekisho) format Jepang.", ja: "履歴書をJapanese形式の履歴書（rirekisho）PDFに変換します。" },
    generateShokumu: { en: "Generate 職務経歴書",    id: "Buat 職務経歴書",  ja: "職務経歴書を生成" },
    shokumuSub:      { en: "We'll convert your resume into a Japanese-format 職務経歴書 (shokumukeirekisho) PDF.", id: "Kami akan mengubah resume kamu menjadi PDF 職務経歴書 (shokumukeirekisho) format Jepang.", ja: "履歴書をJapanese形式の職務経歴書（shokumukeirekisho）PDFに変換します。" },
    // DocumentWizard
    wizStep1Title:   { en: "Select a resume",      id: "Pilih resume",     ja: "履歴書を選択" },
    wizNoResumes:    { en: "No resumes found.",     id: "Tidak ada resume ditemukan.", ja: "履歴書が見つかりません。" },
    wizUploadFirst:  { en: "Upload one first.",     id: "Unggah dulu.",     ja: "先にアップロードしてください。" },
    wizUploaded:     { en: "Uploaded",              id: "Diunggah",         ja: "アップロード済み" },
    wizPrimary:      { en: "Primary",               id: "Utama",            ja: "メイン" },
    wizNext:         { en: "Next →",                id: "Berikut →",        ja: "次へ →" },
    wizStep2Title:   { en: "Job context (optional)", id: "Konteks pekerjaan (opsional)", ja: "求人コンテキスト（任意）" },
    wizStep2Sub:     { en: "Paste a job posting ID to tailor the document to a specific role. You can skip this and generate a general-purpose document.", id: "Tempel ID lowongan untuk menyesuaikan dokumen. Kamu bisa melewati ini untuk membuat dokumen umum.", ja: "求人IDを入力して特定の職種向けに書類を最適化できます。省略すると汎用書類が生成されます。" },
    wizJobIdPlaceholder: { en: "Job posting ID (optional)", id: "ID lowongan kerja (opsional)", ja: "求人ID（任意）" },
    ...
    wizGenWait:      { en: "Generation takes 20–60 seconds. You'll be taken to the status page where you can track progress and download the PDF when ready.", id: "Pembuatan membutuhkan 20–60 detik. Kamu akan dibawa ke halaman status.", ja: "生成には20〜60秒かかります。ステータスページでPDFをダウンロードできます。" },
  ...
  // ---------------------------------------------------------------------------
  culture: {
    title:           { en: "Japanese Workplace Culture", id: "Budaya Tempat Kerja Jepang", ja: "日本の職場文化" },
    sub:             { en: "Learn workplace norms, etiquette, and key Japanese terms to succeed in a Japanese company.", id: "Pelajari norma tempat kerja, etiket, dan istilah Jepang untuk sukses di perusahaan Jepang.", ja: "日本企業で成功するための職場規範、マナー、重要な用語を学びましょう。" },
    topicsTab:       { en: "Topics",           id: "Topik",          ja: "トピック" },
    glossaryTab:     { en: "Glossary",         id: "Glosarium",      ja: "用語集" },
    allTags:         { en: "All",              id: "Semua",          ja: "すべて" },
    noTopics:        { en: "No articles yet. Check back soon.", id: "Belum ada artikel. Periksa kembali nanti.", ja: "まだ記事がありません。後でご確認ください。" },
    noGlossary:      { en: "No glossary entries yet.", id: "Belum ada entri glosarium.", ja: "まだ用語集の項目がありません。" },
    ...
    noMatch:         { en: "No matching terms.", id: "Tidak ada istilah yang cocok.", ja: "一致する用語がありません。" },
    notFound:        { en: "Article not found.", id: "Artikel tidak ditemukan.", ja: "記事が見つかりません。" },
